...
Khi người dùng gõ vào khung chat: "Tôi muốn bộ đồ ABCXYZ". Hệ thống sẽ làm các bước sau:
* Gửi câu hỏi này lên Bedrock để biến nó thành một Vector (tạo ra một tọa độ mới trên bản đồ).
* Cầm tọa độ này, đi vào Vector Database và chạy một thuật toán gọi là Cosine Similarity (đo góc giữa hai vector, chứ không phải đo khoảng cách thẳng thông thường).
* Nói theo ngôn ngữ bình dân: Database sẽ dùng thước đo góc để xem trên bản đồ hàng ngàn chiều đó, những tài liệu nào nằm ở gần tọa độ của câu hỏi nhất.
* Lấy ra top 5 kết quả gần nhất (chính là những đoạn text nói về áo cộc tay, quần đùi) và đẩy đống text đó cho mô hình ngôn ngữ lớn (LLM) để nó tổng hợp lại thành câu trả lời tự nhiên nhất.

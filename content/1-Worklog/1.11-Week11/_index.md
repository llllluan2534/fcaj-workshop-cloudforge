...
| 3   | - **Learning Content:** <br>&emsp; + S3 Storage Classes: Analyzing S3 Standard, Intelligent-Tiering, Glacier, and selecting the right class. <br>&emsp; + Lifecycle Policies: Automating data transitions and deletions over time to optimize costs. <br>- **Project - Smart Media Analysics (Frontend):** <br>&emsp; + Integrate Video List API for the Dashboard, supporting pagination and realtime status indicators. <br>&emsp; + Implement secure Asset Deletion flow (disabling deletion while processing). | 05/22/2026 | 05/22/2026      | <https://000057.awsstudygroup.com/> |
...
| 5   | - **Practice:** <br>&emsp; + Create an S3 bucket with standard security configurations; experiment with enabling/disabling Versioning to track file changes. <br>&emsp; + Upload, download, and configure metadata for objects. Update files to observe how S3 stores multiple versions. <br>- **Project - Smart Media Analysics (Frontend):** <br>&emsp; + Integrate Dynamic Tags API to replace hardcoded data on the Dashboard. <br>&emsp; + Build the Settings page UI structure (Dark/Light mode toggles and AI Preferences). | 05/24/2026 | 05/24/2026      | <https://000057.awsstudygroup.com/> |

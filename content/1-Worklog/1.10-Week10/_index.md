...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | --------------- | ----------------------------------------- |
| 2   | - **Learning Content:** <br>&emsp; + Learn what an IAM role is and how applications can securely access AWS services (without hardcoding access keys). <br>&emsp; + Master the principles of granting least privilege. <br>- **Project - Smart Media Analysics (Frontend):** <br>&emsp; + Integrate actual GET Assets & Scenes APIs from Backend and replace all Mock Data. <br>&emsp; + Stream real video from the returned URL and sync URL parameters (`?t=`) for auto-seeking. | 05/28/2026 | 05/28/2026 | <https://000048.awsstudygroup.com/> |
...
| 4   | - **Learning Content:** <br>&emsp; + Understand what AWS Cloud9 is and how it operates backed by EC2. <br>&emsp; + Explore working in the IDE (file explorer, terminal, editor) directly in the browser. <br>- **Project - Smart Media Analysics (Frontend):** <br>&emsp; + Integrate actual In-Video Search API (POST `/search` filtered by asset_id). <br>&emsp; + Install and set up `wavesurfer.js` to render Audio Waveforms synchronized seamlessly with the video playhead. | 05/30/2026 | 05/30/2026      | <https://000049.awsstudygroup.com/>       |

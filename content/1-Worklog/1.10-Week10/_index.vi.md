...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | --------------- | ----------------------------------------- |
| 2   | - **Learning Content:** <br>&emsp; + Tìm hiểu IAM role là gì và cách ứng dụng truy cập AWS services an toàn (không hardcode access key). <br>&emsp; + Nắm vững các nguyên tắc cấp quyền tối thiểu. <br>- **Project - Smart Media Analysics (Frontend):** <br>&emsp; + Tích hợp API GET Assets & Scenes thật từ Backend và thay thế toàn bộ Mock Data. <br>&emsp; + Stream video thực tế từ URL trả về và đồng bộ tham số URL (`?t=`) để auto seek. | 28/05/2026 | 28/05/2026 | <https://000048.awsstudygroup.com/> |
...
| 4   | - **Learning Content:** <br>&emsp; + Tìm hiểu AWS Cloud9 là gì và cách thức hoạt động dựa trên EC2. <br>&emsp; + Khám phá cách làm việc trong IDE (file explorer, terminal, editor) ngay trên trình duyệt. <br>- **Project - Smart Media Analysics (Frontend):** <br>&emsp; + Tích hợp tìm kiếm In-Video Search API thực tế (POST `/search` filter theo asset_id). <br>&emsp; + Cài đặt thư viện wavesurfer.js để vẽ Audio Waveform đồng bộ trực tiếp với video playhead. | 30/05/2026   | 30/05/2026      | <https://000049.awsstudygroup.com/>       |

...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | --------------- | ----------------------------------------- |
| 2   | - **Learning Content:** <br>&emsp; + Hybrid DNS & Route 53 Resolver Overview: Combining on-premise (or AD) DNS with AWS DNS. <br>&emsp; + Outbound Endpoint (Red Arrow): Allowing Route 53 Resolver to send outbound DNS queries. <br>- **Project - Smart Media Analysics (Frontend):** <br>&emsp; + Build component structure for the Search page (SearchPage, SearchBar, SearchFilters, SearchResultList...). <br>&emsp; + Develop responsive layout and display Filter Chips for Media Type and Tags. | 06/11/2026 | 06/11/2026      | <https://000010.awsstudygroup.com/> |
| 3   | - **Learning Content:** <br>&emsp; + Resolver Rules (Forwarding rule): Defining rules to forward queries to target DNS servers via Outbound Endpoints. <br>&emsp; + Inbound Endpoint (Blue Arrow): Allowing external DNS systems to send queries into the VPC for Route 53 Resolver to answer. <br>&emsp; + DNS forwarding from on-prem/AD to AWS: Configuring rules on internal DNS. <br>- **Project - Smart Media Analysics (Frontend):** <br>&emsp; + Configure top_k dropdown and develop SearchResultCard showing Thumbnail, Asset Name, Timestamp, Score. <br>&emsp; + Initialize Mock data `src/mocks/searchResults.js` and implement formatting (Score, Timestamp). | 06/12/2026 | 06/12/2026      | <https://000010.awsstudygroup.com/> |

...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | --------------- | ----------------------------------------- |
| 2   | - **Learning Content:** <br>&emsp; + Tổng quan về CloudWatch: Công cụ theo dõi hiệu năng và quản lý service, bao gồm metrics, logs, events và alarms. <br>&emsp; + AWS Account & Root User: Hiểu quyền hạn của root user và lý do không nên dùng cho các tác vụ thường ngày. <br>- **Project - Smart Media Analysics (Frontend):** <br>&emsp; + Xây dựng các component chính: MediaCard, FilterDropdown, Pagination. <br>&emsp; + Phát triển giao diện Dashboard (Grid responsive 2-4 cột) và hiển thị EmptyState. | 04/06/2026   | 04/06/2026      | <https://000008.awsstudygroup.com/> |
| 3   | - **Learning Content:** <br>&emsp; + Bảo mật Root User: Tại sao MFA lại cực kỳ quan trọng trong việc bảo vệ root user. <br>&emsp; + Tạo IAM User Quản trị: Gán quyền quản trị để giảm thiểu rủi ro bảo mật theo best practices của AWS. <br>&emsp; + Truy cập CloudWatch Console: Cách sử dụng IAM user thay thế root user để quản trị CloudWatch. <br>- **Project - Smart Media Analysics (Frontend):** <br>&emsp; + Khởi tạo mock data (`src/mocks/assets.js`) chuẩn theo field name từ API contract. <br>&emsp; + Lên khung React Query để fetch `GET /api/v1/assets` khi API Backend sẵn sàng. | 05/06/2026   | 05/06/2026      | <https://000008.awsstudygroup.com/> |
